...
NGame = {
	...
	LAG_DAYS_FOR_PAUSE = 250,						-- Days of client lag for pause of gamespeed.
...
NCountry = {
	...
	COUNTRY_LEADER_FEMALE_CHANCE = 0.0,
	...
	POLITICAL_POWER_CAP = 2000000.0,			    -- Max amount of political power country should have
...
NMilitary = {
	...
	BASE_COMBAT_WIDTH = 200,                        -- base combat width
